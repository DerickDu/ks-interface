...
import { Spin, Card, Statistic, Divider, Tag, Row, Col } from "antd";
import {
  DatabaseOutlined,
  WifiOutlined,
  FileTextOutlined,
        ...
        <div>
          ...
          <div style={{ marginBottom: isMobile ? "8px" : "12px" }}>
            ...
            <div
              style={{
                // 优化折叠状态下的高度控制
                maxHeight: isSourceCollapsed ? "0" : "1000px",
                overflow: "hidden",
                marginTop: isMobile ? "4px" : "6px",
                // 在折叠状态下不占用任何空间
                opacity: isSourceCollapsed ? 0 : 1,
                // 合并过渡效果
                transition:
            ...
            {canShowSideBySide ? null : (
              ...
              >
                ...
                >
                  {isSourceCollapsed ? "展开来源统计 ▼" : "收起来源统计 ▲"}
                </span>
              </div>
            )}
          </div>
